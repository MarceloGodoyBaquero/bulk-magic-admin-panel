...
export const getServerSideProps: GetServerSideProps = async (context) => {
  const res = await fetch(`https://jsonplaceholder.typicode.com/posts?_page=${context.query.page}&_limit=10`)
...
export default function Merchants({pageProps}: AppProps) {
      ...
      <Container sm>
        ...
        >
          ...
          <Table.Pagination
            ...
            align="center"
            rowsPerPage={7}
            onPageChange={(page) => router.push(`/admin/merchants?page=${page}`)}
          />
        </Table>
        <Spacer y={1}/>
